    ...
    <section id="home" className="relative px-[5%] md:px-[10%] flex flex-col justify-center min-h-[100vh] z-[1]">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex gap-4 mt-10 justify-center md:justify-start">
          <motion.a variants={iconVariants} href="#" className="w-[45px] h-[45px] rounded-full bg-white/10 hover:bg-white/15 flex justify-center items-center text-foreground transition-colors duration-300" aria-label="GitHub">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.2c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/>
              <path d="M9 18c-4.51 2-5-2-7-2"/>
            </svg>
          </motion.a>
          <motion.a variants={iconVariants} href="#" className="w-[45px] h-[45px] rounded-full bg-white/10 hover:bg-white/15 flex justify-center items-center text-foreground transition-colors duration-300" aria-label="Email">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <rect width="20" height="16" x="2" y="4" rx="2"/>
              <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
            </svg>
          </motion.a>
          <motion.a variants={iconVariants} href="#" className="w-[45px] h-[45px] rounded-full bg-white/10 hover:bg-white/15 flex justify-center items-center text-foreground transition-colors duration-300" aria-label="LinkedIn">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
